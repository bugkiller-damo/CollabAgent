...
function registerDispatchCreate(parent: Command) {
  parent
    .command("create")
...
function registerDispatchList(parent: Command) {
  parent
    .command("list")
...
function registerDispatchReport(parent: Command) {
  parent
    .command("report")
...
function registerDispatchCancel(parent: Command) {
  parent
    .command("cancel")
...
function registerAgentDuty(parent: Command) {
  parent
    .command("duty")
...
function registerAgentLs(parent: Command) {
  parent
    .command("ls")
...
const dispatchCmd = program.command("dispatch").description("Manager/worker task dispatch operations");
registerDispatchCreate(dispatchCmd);
registerDispatchList(dispatchCmd);
registerDispatchReport(dispatchCmd);
registerDispatchCancel(dispatchCmd);
...
const agentCmd = program.command("agent").description("Agent duty / listing");
registerAgentDuty(agentCmd);
registerAgentLs(agentCmd);
