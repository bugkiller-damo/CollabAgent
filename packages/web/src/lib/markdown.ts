/**
 * Markdown 渲染安全链（#18：从 MarkdownContent.vue 抽出，使 XSS 回归网可在 node 测试中运行）。
 *
 ...
 * - highlight     → highlight.js 回调（与 React rehype-highlight 的着色行为一致，主题随本模块引入）
 */
import DOMPurify from "dompurify";
// lib/common = 36 常用语言子集（全量 ~190 语言曾把入口 chunk 撑到 1.24MB，见审计 §4.4 #17）
import hljs from "highlight.js/lib/common";
// 主题随本模块走（原 main.ts 全局引入）；pre 底色由 style.css .md-content 自带，此处只供 token 配色
