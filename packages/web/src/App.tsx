...
const AgentManagement = lazy(() =>
  import("./pages/admin/AgentManagement").then((m) => ({ default: m.AgentManagement })),
);
const ChannelManagement = lazy(() =>
  import("./pages/admin/ChannelManagement").then((m) => ({ default: m.ChannelManagement })),
);
const WorkspaceMembers = lazy(() =>
  import("./pages/admin/WorkspaceMembers").then((m) => ({ default: m.WorkspaceMembers })),
);
    ...
    <Routes>
      ...
      <Route element={<AuthGuard />}>
        <Route element={<AppLayout />}>
          ...
          />
          <Route
            path="/channels/:channelName/:threadId"
            element={
              <Suspense fallback={<PageLoading />}>
                <ThreadView />
              </Suspense>
