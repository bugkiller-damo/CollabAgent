...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <form onSubmit={handleLogin} className="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg w-96 space-y-4">
        <h1 className="text-gray-900 dark:text-white text-2xl font-bold text-center">CollabAgent</h1>
        ...
        <button type="button" onClick={handleDevBypass}
          className="w-full p-2 rounded bg-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-500 text-sm">
          开发模式：跳过登录
        </button>
      </form>
    </div>
