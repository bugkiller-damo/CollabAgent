  ...
  return (
    <div className="flex h-full">
      <nav className="w-48 p-4 border-r border-gray-700 space-y-1">
        ...
        <button onClick={() => navigate("/settings/integrations")} className={linkCls("/settings/integrations")}>集成</button>
        <button onClick={() => navigate("/settings/notifications")} className={linkCls("/settings/notifications")}>通知</button>
      </nav>
