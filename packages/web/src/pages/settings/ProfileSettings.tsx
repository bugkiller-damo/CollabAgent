  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="w-full">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            />
            <Button onClick={() => avatarInputRef.current?.click()} disabled={avatarUploading} size="sm" variant="secondary">
      ...
      <Card className="w-full">
        ...
        <Input type={showPw ? "text" : "password"} value={oldPw} onChange={(e) => setOldPw(e.target.value)} placeholder="当前密码" />
        <div>
        ...
        <Button onClick={handleChangePassword} size="sm">修改密码</Button>
