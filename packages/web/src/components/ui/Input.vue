...
// 纯样式包装：value / onInput / placeholder / type 等原生属性与父级 class 全部 fallthrough 到 input。
// 对齐 React 受控写法：父组件用 :value + @input（Input 不支持 v-model）。
...
// 对齐 React forwardRef：父组件模板 ref 上可直接访问 el（已解包为 DOM 元素）与 focus()
